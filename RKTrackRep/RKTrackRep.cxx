...
void RKTrackRep::setData(const TMatrixT<double>& st, const GFDetPlane& pl, const TMatrixT<double>* cov){
  if(pl!=fCachePlane){
...
RKTrackRep::RKTrackRep() : GFAbsTrackRep(5),fDirection(true),fPdg(0),fMass(0.){
}
