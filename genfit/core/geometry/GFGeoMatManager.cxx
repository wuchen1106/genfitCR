...
void GFGeoMatManager::getMaterialParameters(double& matDensity,
                                            double& matZ,
                                            double& matA,
...
void GFGeoMatManager::initTrack(const double& posx,
                                const double& posy,
                                const double& posz,
                                const double& dirx,
                                const double& diry,
...
double GFGeoMatManager::stepOrNextBoundary(const double& maxStep){
