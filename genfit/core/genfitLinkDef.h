...
#pragma link C++ class GFAbsEnergyLoss+;
#pragma link C++ class GFEnergyLossBetheBloch+;
#pragma link C++ class GFEnergyLossBrems+;
#pragma link C++ class GFEnergyLossCoulomb+;
#pragma link C++ class GFMaterialEffects+;
#pragma link C++ class GFAbsGeoMatManager+;
#pragma link C++ class GFGeoMatManager+;
